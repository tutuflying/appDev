//
//  KWTTDListTableViewController.m
//  Smarty
//
//  Created by 依军 赵 on 14-4-29.
...
@implementation KWTTDListTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [[self getDevices][indexPath.row] valueForKey:@"name"];
